...
{
    public partial class GroupAdditionSecurityPicker : IDataErrorInfo
    {
        ...
        public GroupAdditionSecurityPicker()
        {
            InitializeComponent();
            DataContext = this;
        ...
        public GroupAdditionSecurityPicker(AgentManager agent, int editIndex)
        {
            InitializeComponent();
            DataContext = this;
            InitFields(agent);
