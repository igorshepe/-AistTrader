	...
	public partial class SecuritiesWindow
	{
		...
		private void NewOrderClick(object sender, RoutedEventArgs e)
		{
			var newOrder = new OrderWindow
			{
				...
				SecurityProvider = MainWindow.Instance.ConnectionManager.Connections.FirstOrDefault(),
				MarketDataProvider = MainWindow.Instance.ConnectionManager.Connections.FirstOrDefault(),
